...
class Product(models.Model):
    ...
    image_thumbnail = ImageSpecField(
        ...
        processors=[ResizeToFit(720, 520)],
...
class PromoCode(models.Model):
    ...
    applicable_products = models.ManyToManyField(Product, blank=True, related_name='promocodes', help_text="Товары, к которым применяется промокод")               
    ...
    def is_valid(self):
        ...
        return (
            ...
            and Decimal('0') < self.discount <= Decimal('100')
...
class Order(models.Model):
    ...
    promocode = models.ForeignKey(PromoCode, on_delete=models.SET_NULL, null=True, blank=True, related_name='orders')               
    ...
    def total_cost(self):
        ...
        if self.promocode and self.promocode.is_valid():
            ...
            eligible_total = sum(
                ...
                if not applicable_ids or item.product_id in applicable_ids

            )

            base_total -= eligible_total * (self.promocode.discount / Decimal('100'))
